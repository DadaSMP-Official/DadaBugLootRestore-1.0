...
**DadaBugLootRestore 1.0** is a custom Minecraft plugin for Paper/Spigot servers.

Salva il loot alla morte e permette allo staff di ridarlo se la morte era causata da bug.

| Field | Value |
| --- | --- |
| Plugin | `DadaBugLootRestore` |
| Version | `1.0` |
| Category | Custom Server Tool |
| Main class | `it.dadasmp.bugloot.DadaBugLootRestore` |
...
`release/DadaBugLootRestore-1.0.jar`
